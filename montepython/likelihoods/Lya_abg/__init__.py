...
#           exit()
        ...
        data.derived_lkl = {'alpha': 0, 'beta': 0, 'gamma': 0} #this is just to initialise our derived parameters to avoid the rare case of an error in the first point
...
### end of block ####
    ...
    def loglkl(self, cosmo, data):
        ...
        data.derived_lkl = {'alpha': best_alpha, 'beta': best_beta, 'gamma': best_gamma, 'lya_neff':neff} #check that neff is stored accurately
