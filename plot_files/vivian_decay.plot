...
info.redefine = {'omega_ini_dcdm':'omega_ini_dcdm/(omega_ini_dcdm+omega_cdm)','N_ur':'N_ur+1.0132-3.046'}
...
info.to_change = {'omega_ini_dcdm':r'$f_{\rm dcdm}$','log10_Gamma_dcdm':r'${\rm log}_{10}\Gamma_{\rm dcdm}$','omega_cdm':r'$\omega_{\rm dmtot}$','N_ur':r'$\Delta N_{\rm eff}$','H0':'H_0','log10_Gamma_dcdm2bar':r'${\rm log}_{10}\Gamma_{\rm dcdm}$'}
...
info.to_plot = [r'${\rm log}_{10}\Gamma_{\rm dcdm}$',r'$f_{\rm dcdm}$',r'$\omega_{\rm dmtot}$','H_0',r'$\Delta N_{\rm eff}$']
