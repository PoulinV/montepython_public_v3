...
info.to_change = {'100*theta_s':r'$100~\theta_s$','omega_dcdmdr':r'$\omega_{\rm dcdm+dr}$','M_tot':r'$\sum m_\nu$','Delta_Neff':r'$\Delta$ N$_{\rm eff}$','H0':'H_0','w0_fld':r'$w_0$','wa_fld':r'$w_a$','N_ur':r'$N_{\rm eff}$','log10_Gamma_neutrinos':r'${\rm Log}_{10}\Gamma_\nu$'}
...
info.legendnames = ['Gamma = 0','Gamma = 10']
#info.legendnames = ['stable','decaying']
info.ticknumber = 4
info.ticksize = 14
info.line_width = 2
info.fontsize = 25
