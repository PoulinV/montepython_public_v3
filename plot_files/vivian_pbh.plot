...
#info.redefine={'log10PBH_low_mass':'10**log10PBH_low_mass'}
...
info.to_change={'PBH_fraction':r'$f_{\rm PBH}$'}
...
info.to_plot = ['omega_b','tau_reio','omega_cdm','100*theta_s', 'ln10^{10}A_s','n_s',r'$100~\theta_s$',r'$M_{\rm PBH}/M_\odot$',r'$f_{\rm PBH}$','log10PBH_fraction','PBH_fraction']
