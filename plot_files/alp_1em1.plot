...
info.redefine={'Omega_many_fld':'Omega_many_fld*H0*H0/100/100','log10_a_c':'10**log10_a_c','Omega_axion_ac':'Omega_axion_ac/(Omega_axion_ac+Omega_m*(1e-1)**(-3)+(2.47310e-5*1.445)*(1e-1)**(-4)+Omega_Lambda)'}
