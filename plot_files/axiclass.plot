...
#info.to_change={'Omega_many_fld':r'$\Omega_{\rm EDE}$','Omega_axion_ac':r'$f_{\rm axion}(a_c)$','log10_Omega_axion_ac':r'$f_{\rm axion}(a_c)$','H0':'H_0','sigma8':r'$S_8$','N_ur':r'$\Delta N_{\rm eff}$','log10_axion_ac':r'${\rm Log}_{10}a_c$','100*theta_s':r'$100~\theta_s$','100*theta_d':r'$100~\theta_d$','f_axion':r'$\alpha$','m_axion':r'$\mu$','scf_parameters__1':r'$\theta_i$'}
